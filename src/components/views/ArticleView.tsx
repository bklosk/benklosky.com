      ...
      <div className="flex-1 max-w-3xl mx-auto w-full min-h-0 overflow-y-auto py-4 lg:py-0 pr-2 sm:pr-4 pl-0">
        ...
        >
          <ReactMarkdown
            components={{
              p: ({ children }) => (
                <p className="text-[15px] sm:text-base lg:text-lg text-taupe/80 leading-relaxed mb-6 max-w-[65ch]">
                  {children}
                </p>
              ),
              ...
              li: ({ children }) => (
                <li className="text-[15px] sm:text-base lg:text-lg text-taupe/80 leading-relaxed mb-2 ml-4 list-disc">
                  {children}
                </li>
              ),
            }}
        ...
        >
          <button 
            onClick={onClose}
            className="mono text-xs text-taupe/50 hover:text-tiger-flame transition-colors min-h-[44px] min-w-[44px] -ml-2 -mb-2 py-2 pr-2"
          >
            ← BACK TO HOME
          </button>
        </motion.div>
