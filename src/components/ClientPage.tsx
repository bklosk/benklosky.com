...
export default function ClientPage({ articles }: ClientPageProps) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col lg:flex-row bg-parchment overflow-hidden texture-overlay">
      ...
      {/* Main Content Area */}
      <main className="flex-1 lg:ml-14 xl:ml-16 lg:mr-32 xl:mr-48 flex flex-col overflow-hidden relative z-10 pb-[max(1.5rem,env(safe-area-inset-bottom))] lg:pb-0 h-full lg:h-screen min-h-0">
